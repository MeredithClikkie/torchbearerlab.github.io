...
stop_words = [
    ...
    "not", "no", "yes", "so", "can", "just", "dont", "yeah", "let", "im", "ah", "want", "like", "ive", "all", "ooh", "ill", "even", "forforforforforfor", "yeahyeahyeahyeah", "daisychained" "thats", "there", "oh"
]
...
lyrics = """You-ooh-ooh can have all I've made and all I've ever known
...
plt.title('Downstairs Frequent Words')
plt.tight_layout()

# Save or display
plt.savefig('downstairs_bar.png')
# %% [markdown]
# ### Downstairs Lollipop Chart
# %%
...
plt.title('Downstairs Lollipop)', fontsize=14, fontweight='bold')
...
# 4. Save or display
plt.savefig('downstairs_lollipop.png')
plt.show()
# %% [markdown]
# ### Downstairs Bubble Chart
# %%
# 1. Prepare your data (from your existing code)
df_counts = pd.DataFrame(counts.most_common(15), columns=['Word', 'Count'])
...
# 4. Styling
plt.title('Downstairs Treemap', fontsize=16)
plt.axis('off') # Treemaps don't need axes

plt.tight_layout()
plt.savefig('downstairs_treemap.png')
plt.show()
# %% [markdown]
# ### Downstairs Word Cloud
# %%
...
plt.title("Downstairs Radial", va='bottom')
plt.show()
# %% [markdown]
# ### Downstairs Funnel Chart
# %%
df_counts = pd.DataFrame(counts.most_common(15), columns=['Word', 'Count'])

fig = px.funnel(df_counts, x='Count', y='Word',
                title='Downstairs Funnel',
                color = 'Word',
