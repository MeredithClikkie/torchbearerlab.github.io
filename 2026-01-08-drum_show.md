...
stop_words = [
    ...
    "not", "no", "yes", "so", "can", "just", "dont", "yeah", "let", "im", "ah", "want", "like", "ive", "all", "ooh", "ill", "even", "forforforforforfor", "yeahyeahyeahyeah", "daisychained" "thats", "there", 'hell'
]
...
plt.title('Drum Show Bar')
plt.tight_layout()

# Save or display
plt.savefig('drum_show_bar.png')
# %% [markdown]
# ### Drum Show Lollipop
# %%
...
plt.title('Drum Show Lollipop', fontsize=14, fontweight='bold')
...
# 4. Save or display
plt.savefig('drum_show_lollipop.png')
plt.show()
# %% [markdown]
# ### Drum Show Bubble Chart
# %%
# 1. Prepare your data (from your existing code)
df_counts = pd.DataFrame(counts.most_common(15), columns=['Word', 'Count'])
...
# 4. Styling
plt.title('Drum Show Treemap', fontsize=16)
plt.axis('off') # Treemaps don't need axes

plt.tight_layout()
plt.savefig('drum_show_treemap.png')
plt.show()
# %% [markdown]
# ## Drum Show Word Cloud
# %%
...
plt.title("Drum Show Radial", va='bottom')
plt.show()
# %% [markdown]
# ### Drum Show Funnel Chart
# %%
df_counts = pd.DataFrame(counts.most_common(15), columns=['Word', 'Count'])

fig = px.funnel(df_counts, x='Count', y='Word',
                title='Drum ShowFrequency Funnel',
                color = 'Word',
