...
plt.title('Robot Voices Frequent Words')
plt.tight_layout()

# Save or display
plt.savefig('robot_voices_bar.png')
# %% [markdown]
# ### Robot Voices Lollipop
# %%
...
plt.title('Robot Voices Lollipop', fontsize=14, fontweight='bold')
...
# 4. Save or display
plt.savefig('robot_voices_lollipop.png')
plt.show()
# %% [markdown]
# ### Robot Voices Bubble Chart
# %%
# 1. Prepare your data (from your existing code)
df_counts = pd.DataFrame(counts.most_common(15), columns=['Word', 'Count'])
...
# 4. Styling
plt.title('Robot Voices Treemap', fontsize=16)
plt.axis('off') # Treemaps don't need axes

plt.tight_layout()
plt.savefig('robot_voices_treemap.png')
plt.show()
# %% [markdown]
# ### Robot Voices Word Cloud
# %%
...
plt.title("Robot Voices Radial", va='bottom')
plt.show()
# %% [markdown]
