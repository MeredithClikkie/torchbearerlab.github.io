...
![Figure 1]({{ site.baseurl }}/assets/images/D599t2viz1.jpg) Charges: Histogram with KDE curve, Boxplot, & Q-Q Plot — Interpretation: Charges have a right-skewed distribution (positive skew), heavy‑tailed, meaning the mean is pulled higher than the median.
